# ⸰ Zombie Infection 🧪 ๋࣭ ⭑
O projeto trata-se da recriação e implementação do jogo "Bloons" do gênero tower defense, utilizando a biblioteca LibGDX, para a disciplina e Linguagens e técnicas de programação 2. Além disso, envolve a recriação do jogo "Plants vs Zombies", buscando reviver a essência do sucesso original e adaptá-lo a uma experiência nostálgica, com inovações que atraem novos públicos, utilizando estímulos visuais únicos para prender a atenção.
...
- [Luan Seta Ramos](https://github.com/setinhaw)
- [Luiza Andressa Vailante Silva](https://github.com/luhvailante1234)
- [Maria Eduarda Oliveira Pereira](https://github.com/twllips)
- [Maria Luiza Ferreira Meireles](https://github.com/MariaLuizaFerreira)
- [Mel Raposeiras Ricaldoni](https://github.com/fraise-renard)
- [Miguel Dos Santos Miranda](https://github.com/Miguelkkkk)
- [Núbia Torres De Oliveira](https://github.com/nubyoli)
- [Otto Emanuel Martins Abreu](https://github.com/Otto-abreu)
- [Pedro Guimarães De Deus Corrêa](https://github.com/PedroRamonee)
- [Pedro Lucas Albano Fernandes](https://github.com/Albano0)
- [Sarah Dos Santos Oliveira](https://github.com/SarahSdSO)
- [Sarah Rabelo Araujo](https://github.com/LoiraDoTchan)
- [Victor Hugo Gonçalves Da Luz Miranda](https://github.com/VictorGonce)
- [Vitória Fernanda Santos Rocha](https://github.com/Vick1608)
- [Vinicius Domingos Candido](https://github.com/ViniciusCandido0)
